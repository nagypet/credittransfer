...
package hu.perit.credittransferservice.documentation;
...
public class SwaggerConfig
{
    ...
    public OpenAPI openApi()
    {
        return new OpenAPI()
                .info(new Info()
                        .title("creadit-transfer-service")
                        .description("creadit-transfer-service")
                        .version("1.0")
                        .license(new License()
                        ...
                        .contact(new Contact()
                                .name("Peter Nagy")
                                .url("https://github.com/nagypet/credittransfer")
